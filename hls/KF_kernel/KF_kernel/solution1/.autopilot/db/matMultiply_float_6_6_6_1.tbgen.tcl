...
set C_modelArgList {
	...
	{ K float 32 regular {array 18 { 1 3 } 1 1 } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "mat_out", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "K", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ mat_out_address0 sc_out sc_lv 6 signal 0 } 
	{ mat_out_ce0 sc_out sc_logic 1 signal 0 } 
	{ mat_out_we0 sc_out sc_logic 1 signal 0 } 
	{ mat_out_d0 sc_out sc_lv 32 signal 0 } 
...
set Spec2ImplPortList { 
	...
	K { ap_memory {  { K_address0 mem_address 1 5 }  { K_ce0 mem_ce 1 1 }  { K_q0 mem_dout 0 32 } } }
}
