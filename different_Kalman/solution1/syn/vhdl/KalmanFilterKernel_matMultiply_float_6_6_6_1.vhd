...
attribute shreg_extract : string;
    ...
    signal empty_33_fu_189_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal empty_33_reg_312 : STD_LOGIC_VECTOR (4 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln13_fu_149_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                empty_33_reg_312 <= empty_33_fu_189_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state8)) then
                mul_reg_368 <= grp_fu_2627_p_dout0;
            end if;
        end if;
    end process;
    empty_reg_307(0) <= '0';
    ...
    add_ln27_fu_241_p2 <= std_logic_vector(unsigned(zext_ln23_fu_231_p1) + unsigned(empty_33_reg_312));
    ...
    empty_33_fu_189_p2 <= std_logic_vector(unsigned(p_shl_fu_181_p3) - unsigned(zext_ln13_fu_145_p1));
    ...
    grp_fu_133_p1 <= H_q0;
    grp_fu_133_p2 <= grp_fu_2627_p_dout0;
    grp_fu_2627_p_ce <= ap_const_logic_1;
    grp_fu_2627_p_din0 <= mat_in_L_q0;
    grp_fu_2627_p_din1 <= H_q0;
